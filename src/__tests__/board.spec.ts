...
describe('board component', () => {
  ...
  it('action possibleMoves', async () => {
    ...
    expect(model.hud_board.at(0, 1).value).toEqual(0)
    expect(model.hud_board.at(1, 0).value).toEqual(0)

    expect(model.hud_board.at(1, 2).value).toEqual(1)
    expect(model.hud_board.at(2, 1).value).toEqual(1)
    expect(model.hud_board.at(2, 3).value).toEqual(1)
    expect(model.hud_board.at(2, 0).value).toEqual(1)
    expect(model.hud_board.at(1, 1).value).toEqual(1)
    expect(model.hud_board.at(0, 2).value).toEqual(1)
    expect(model.hud_board.at(1, 3).value).toEqual(1)
    expect(model.hud_board.at(2, 4).value).toEqual(1)
    expect(model.hud_board.at(3, 1).value).toEqual(1)
    expect(model.hud_board.at(3, 3).value).toEqual(1)

    expect(model.hud_board.at(3, 2).value).toEqual(0)
    expect(model.hud_board.at(4, 2).value).toEqual(0)
  ...
  it('dismiss hud', async () => {
    ...
    expect(model.hud_board.at(1, 0).value).toEqual(0)
    expect(model.hud_board.at(0, 1).value).toEqual(0)
    expect(model.hud_board.at(1, 2).value).toEqual(0)
    expect(model.hud_board.at(2, 1).value).toEqual(0)
  })
})
